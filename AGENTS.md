...
- **Benchmarks (Pixi + Nextflow):** `benchmarks/at_scale/` — `pixi run bench`; agent context in [`.agents/skills/seqera/SKILL.md`](.agents/skills/seqera/SKILL.md) and [`.cursor/rules/seqera-ai.mdc`](.cursor/rules/seqera-ai.mdc); discovery layout per [Seqera Skills](https://docs.seqera.io/platform-cloud/seqera-ai/skills).
