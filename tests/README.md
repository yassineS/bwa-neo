...
| **golden_sampe** | `tests/golden_sampe.sh ./bwa` | Paired-end `sampe` first 11 SAM fields for `r1/r2` match `fixtures/tiny_pe/expected.pair.first11.tsv`; `sampe -t` (and `-t 0` clamp) match single-threaded output. |
