...
| **cli_aux** | `tests/cli_aux.sh ./bwa` | Golden checks for `qualfa2fq`, `xa2multi`, `typehla-selctg`, `postalt` stream, and deterministic `typehla` GT output (`tests/fixtures/cli_aux/`). |
