...
4. **`CHANGELOG.md`** entry crediting the original author and linking the upstream issue/PR.
...
Re-run this audit periodically; track merged items in **[`tasks.md`](tasks.md)**.
